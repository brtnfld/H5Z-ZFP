...
help:
	...
	@echo "To sign the plugin for use with HDF5 digital signature verification, add"
	@echo "    SIGNING_KEY=<path-to-private-key.pem>"
	@echo "Optionally set H5SIGN=<path-to-h5sign> if h5sign is not in PATH."
	@echo ""
