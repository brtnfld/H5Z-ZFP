...
!DEC$ATTRIBUTES DLLEXPORT :: H5Z_FILTER_ZFP
!DEC$ATTRIBUTES DLLEXPORT :: H5Z_FILTER_ZFP_VERSION_MAJOR
!DEC$ATTRIBUTES DLLEXPORT :: H5Z_FILTER_ZFP_VERSION_MINOR
!DEC$ATTRIBUTES DLLEXPORT :: H5Z_FILTER_ZFP_VERSION_PATCH
!DEC$ATTRIBUTES DLLEXPORT :: H5Z_ZFP_CD_NELMTS_MEM
!DEC$ATTRIBUTES DLLEXPORT :: H5Z_ZFP_CD_NELMTS_MAX
!DEC$ATTRIBUTES DLLEXPORT :: H5Z_ZFP_MODE_RATE
!DEC$ATTRIBUTES DLLEXPORT :: H5Z_ZFP_MODE_PRECISION
!DEC$ATTRIBUTES DLLEXPORT :: H5Z_ZFP_MODE_ACCURACY
!DEC$ATTRIBUTES DLLEXPORT :: H5Z_ZFP_MODE_EXPERT
!DEC$ATTRIBUTES DLLEXPORT :: H5Z_ZFP_MODE_REVERSIBLE
  ...
  INTERFACE
     !DEC$ ATTRIBUTES DLLEXPORT :: H5Z_zfp_initialize
